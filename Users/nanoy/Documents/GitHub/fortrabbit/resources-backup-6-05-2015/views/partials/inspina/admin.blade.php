    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="side-menu">
            ...
            <li>
             ...
             <li>
                <a href="{{url('/admin/notice')}}"><i class="fa fa-info-circle"></i> <span class="nav-label">Notice Board</span></a>
            </li>
            ...
            <li class="special_link">
                <a href="{{url('/')}}"><i class="fa fa-database"></i> <span class="nav-label" style="color: #ffffff">Client Panel</span></a>
            </li>
        </ul>
