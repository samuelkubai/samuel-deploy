                    ...
                    <div class="ibox">
                        ...
                        <div class="ibox-content">
                            <div class="row m-b-sm m-t-sm">
                                <div class="col-md-1">
                                    <a href="{{ url('/events/attending') }}" id="loading-example-btn" class="btn btn-white btn-sm" ><i class="fa fa-refresh"></i> Refresh</a>
                                </div>
                                <form action="{{ url('/events/attending/search') }}" method="POST">
