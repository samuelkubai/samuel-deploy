...
@section('content')
    <div class="ibox-content forum-post-container">
        <div class="forum-post-info">
            <h4><span class="text-navy"><i class="fa fa-globe"></i> {{ $subject->name }}</span> - <span class="text-muted">{{ $school->username }}</span></h4>
        </div>
        ...
        <form action="{{ url('/'. $school->username .'/'.$subject->name.'/admin/community') }}" method="post" >
