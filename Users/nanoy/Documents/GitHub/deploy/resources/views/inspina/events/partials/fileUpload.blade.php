                                ...
                                <div class="modal inmodal" id="uploadEventFileModal" tabindex="-1" role="dialog" aria-hidden="true">
                                    ...
                                    <div class="modal-content animated bounceInRight">
                                            ...
                                            <form action="{{ url('event/file',$event->folder_id) }}" method="POST" enctype="multipart/form-data">
