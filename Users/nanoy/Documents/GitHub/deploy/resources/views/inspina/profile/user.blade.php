                        ...
                        <div>
                            ...
                            <div class="ibox-content profile-content">
                                ...
                                <div class="user-button">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a href="{{url( '/profile/update/')}}" class="btn btn-default btn-sm btn-block"><i class="fa fa-text"></i> Edit Profile</a>
                                        </div>
                                        <!--<div class="col-md-6">
                                ...
                                <div class="feed-activity-list">
                                    ...
                                    <div class="feed-element">
                                        <a href="#" class="pull-left">
                                            <img alt="image" class="img-circle" src="{{asset('inspina/img/a1.jpg')}}">
                                        </a>
                                    ...
                                    <div class="feed-element">
                                        <a href="#" class="pull-left">
                                            <img alt="image" class="img-circle" src="{{asset('inspina/img/a2.jpg')}}">
                                        </a>
                                        <div class="media-body ">
                                    ...
                                    <div class="feed-element">
                                        <a href="#" class="pull-left">
                                            <img alt="image" class="img-circle" src="{{asset('inspina/img/a3.jpg')}}">
                                        </a>
                                        <div class="media-body ">
                                            <small class="pull-right">2h ago</small>
                                    ...
                                    <div class="feed-element">
                                        <a href="#" class="pull-left">
                                            <img alt="image" class="img-circle" src="{{asset('inspina/img/a5.jpg')}}">
                                        </a>
                                        <div class="media-body ">
                                            <small class="pull-right">2h ago</small>
