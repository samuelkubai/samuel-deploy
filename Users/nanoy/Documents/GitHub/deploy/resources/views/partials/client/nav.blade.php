<!-- BEGIN SIDEBAR MENU -->
        ...
        <ul>
            <li class="start active "> <a href="{{ url('/'.$school->username.'/') }}"> <i class="icon-custom-home"></i> <span class="title">Dashboard</span> <span class="selected"></span> </a> </li>

            <li class=""> <a href="{{ url('/'.$school->username.'/mail/') }}"> <i class="icon-custom-ui"></i> <span class="title">Mail</span><span class=" badge badge-disable pull-right ">203</span></a>
