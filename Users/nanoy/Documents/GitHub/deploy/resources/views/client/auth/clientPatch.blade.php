    ...
    <div class="row login-container animated fadeInUp">
        <div class="col-md-7 col-md-offset-2 tiles white no-padding">
            <div class="p-t-30 p-l-40 p-b-20 xs-p-t-10 xs-p-l-10 xs-p-b-10">
                <h2 class="normal">Register a New Client</h2>
                <p>Link your skoolspace account to a Client Account.<br></p>
                <p class="p-b-20">Sign up Now! for updates on your real time updates on your child.</p>
            </div>
            <div class="tiles grey p-t-20 p-b-20 text-black">
                ...
                @endif
                <form id="frm_register" class="animated fadeIn" method="post" action="{{ url('/patch/ ')}}">
                    ...
                    <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
                        ...
                        <div class="col-md-4 col-sm-4">
                            <input name="middleName" id="reg_first_Name" type="text"  class="form-control" placeholder="Middle Name">
                        </div>
                        <div class="col-md-4 col-sm-4">
                    ...
                    <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
                        <div class="col-md-6 col-sm-6">
                            <input name="admNo" id="admNo" type="text"  class="form-control" placeholder="Admission Number">
                        </div>
                        <div class="col-md-6 col-sm-6">
                            <input name="class" id="class" type="text"  class="form-control" placeholder="Class/Form">
                        </div>
                    </div>
                    <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
                        <div class="col-md-6">
                            <input name="telNumber" id="telNumber" type="text"  class="form-control" placeholder="Telephone Number">
                        </div>
                        <div class="col-md-6">
                    ...
                    <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
                        <div class="col-md-12 ">
                            <input name="username" id="username" type="text"  class="form-control" placeholder="School's Username">
                        </div>
                    </div>
                    <div class="row p-t-10 m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
                        <div class="control-group col-md-3 pull-left">
                            <a href="{{ url('/') }}" class="btn btn-primary btn-cons">Back To Dashboard</a>
                        </div>
