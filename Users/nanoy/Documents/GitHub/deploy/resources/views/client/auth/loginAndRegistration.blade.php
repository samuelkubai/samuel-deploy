    ...
    <div class="row login-container animated fadeInUp">
        <div class="col-md-7 col-md-offset-2 tiles white no-padding">
            <div class="p-t-30 p-l-40 p-b-20 xs-p-t-10 xs-p-l-10 xs-p-b-10">
                ...
                <h2 class="normal">Sign in to {{ $school->schoolName }}</h2>
            ...
            <div class="tiles grey p-t-20 p-b-20 text-black">
                <form id="frm_login" class="animated fadeIn" method="post" action="{{ url($school->username .'/login') }}">
                ...
                <form id="frm_register" class="animated fadeIn" style="display:none" method="post" action="{{ url($school->username .'/register') }}">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}">
                    <div class="row form-row m-l-20 m-r-20 xs-m-l-10 xs-m-r-10">
                        <div class="col-md-12 ">
