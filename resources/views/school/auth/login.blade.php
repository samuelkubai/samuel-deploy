...
<div class="loginColumns animated fadeInDown">
    <div class="row">
        @include('school.auth.partials.message')
        <div class="col-md-6">
            <div class="ibox-content">
                <form class="m-t" role="form" method="post" action="{{ url('/school/admin/login') }}">
                    ...
                    <a class="btn btn-sm btn-white btn-block" href="{{ url('/school/user/register') }}">Create an account</a>
                </form>
                <p class="m-t">
                    <small>skoolspace school's community platform &copy; 2015</small>
                </p>
            </div>
        </div>
    </div>
