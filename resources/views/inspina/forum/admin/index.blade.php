        ...
        <div class="forum-item active">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <a href="{{ url('/'. $school->username .'/admin/general/community') }}" class="forum-item-title">General Discussion</a>
        ...
        <div class="forum-item active">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <a href="{{ url('/'. $school->username.'/admin/announcements/community') }}" class="forum-item-title">Announcements</a>
        ...
        <div class="forum-item">
            <div class="row">
                <div class="col-md-9">
                    ...
                    <a href="{{ url('/'. $school->username .'/admin/staff/community') }}" class="forum-item-title">Staff Discussion</a>
