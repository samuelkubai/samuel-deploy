                    ...
                    <div class="grid simple">
                        ...
                        <div class="grid-body no-border" style="min-height: 850px;">
                            <div class="" >
                                ...
                                <div class="control">
                                    <div class="pull-left">
                                        <label class="inline"><span class="muted">To:</span> <span class="bold small-text">{{ ($admin != null)?(($admin->role != null)?$admin->role: $admin->firstName ." ". $admin->lastName): 'Admin' }}</span></label>
                                    </div>
